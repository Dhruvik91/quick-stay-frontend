...
export const dummyAccommodations: Accommodation[] = [
    {
      ...
      price: 18500,
      rating: 4.7,
      description: 'Modern co-living space with fully furnished rooms, high-speed internet, and regular community events. Perfect for working professionals.',
    ...
    },
    {
      ...
      price: 12500,
      rating: 4.3,
      description: 'Comfortable PG accommodation with homely food and friendly environment. Suitable for students and young professionals.',
    ...
    },
    {
      ...
      price: 35000,
      rating: 4.5,
      description: 'Spacious 2BHK apartment in prime location with modern amenities and close to metro station.',
    ...
    },
    {
      ...
      price: 8500,
      rating: 4.2,
      description: 'Affordable hostel accommodation for students with study rooms and 24/7 security.',
    ...
    },
    {
      ...
      price: 14500,
      description: 'Premium PG accommodation with AC rooms and modern facilities for working professionals.',
      imageUrl: 'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
      verified: false,
    ...
    },
    {
      ...
      price: 42000,
      rating: 4.8,
      description: 'Luxurious 3BHK apartment with panoramic city views and premium amenities in the heart of the city.',
      verified: true,
